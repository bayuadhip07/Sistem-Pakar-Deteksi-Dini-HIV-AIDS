...
if ($_SESSION['status']!="login") {
    echo "<script>alert('Silakan masuk ke akun terlebih dahulu untuk mengakses halaman ini!'); window.location=('/sispak/modul/login.php');</script>";
}
...
<link rel="icon" type="image/png" href="/sispak/assets/image/icon.png">
