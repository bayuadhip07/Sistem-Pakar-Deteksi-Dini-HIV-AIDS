                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                          <table class="table table-striped" id="table_anggota" width="100%">
                              ...
                              <tbody>
                                <?php
                                    $query ="SELECT * FROM basis_pengetahuan INNER JOIN stadium_penyakit ON basis_pengetahuan.id_penyakit=stadium_penyakit.id_penyakit INNER JOIN gejala ON basis_pengetahuan.id_gejala = gejala.id_gejala";
