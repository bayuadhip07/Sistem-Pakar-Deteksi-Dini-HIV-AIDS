<?php $page='basis_pengetahuan';include('../../koneksi.php') ?>
<!DOCTYPE html>
<html lang="en">
  <head>
                      ...
                      <div class="container">
                        <form action="../master_file/sql.php?act=ubahPengetahuan" method="post">   
                            ...
                            <div class="form-group">
                                <label for="stadium">Stadium HIV/AIDS</label>
                                ...
                                <select name="stadium" id="stadium" class="form-control select2" required>
                                    ...
                                    ?>
                                        <option value="<?php echo $b['id_penyakit'] ?>" <?php if($row['id_penyakit'] == $b['id_penyakit']){ echo "selected";} ?>><?php echo $b['stadium_penyakit'] ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                ?>
                                    <option value="<?php echo $a['id_gejala'] ?>" <?php if($row['id_gejala']==$a['id_gejala']){echo "selected";} ?>><?php echo $a['gejala'] ?></option>
                                <?php } ?>
                                </select>
                            </div>
                            <div class="form-group">
