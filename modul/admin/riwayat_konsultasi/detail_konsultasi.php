            ...
            <div class="section-body">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                                <?php
                                    $query ="SELECT * FROM hasil_konsultasi INNER JOIN stadium_penyakit ON hasil_konsultasi.id_penyakit=stadium_penyakit.id_penyakit INNER JOIN pengguna ON hasil_konsultasi.id_pengguna = pengguna.id_pengguna WHERE id_hasil='$id_hasil'";
                                                    ...
                                                    <div style="padding-left: 3%;">
                                                        <?php 
                                                            if($nmpkt[1]!="Tidak Terkena HIV/AIDS"){
                                                                echo "<p style='font-size: 40px;font-weight:500'> Terkena HIV/AIDS $nmpkt[1] </p>";
                                                                $akurasi = $vlpkt[1]*100;
