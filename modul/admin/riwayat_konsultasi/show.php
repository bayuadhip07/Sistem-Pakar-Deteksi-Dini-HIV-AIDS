<?php $page='riwayat';include('../../koneksi.php') ?>
<!DOCTYPE html>
<html lang="en">
  <head>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                          <table class="table table-hover" id="table_anggota" width="100%">
                              ...
                              <tbody>
                                <?php
                                    $query ="SELECT * FROM hasil_konsultasi INNER JOIN stadium_penyakit ON hasil_konsultasi.id_penyakit=stadium_penyakit.id_penyakit INNER JOIN pengguna ON hasil_konsultasi.id_pengguna = pengguna.id_pengguna ORDER BY id_hasil DESC";
                                    ...
                                    <td>
                                        <?php
                                          if($row['nilai_akurasi']==0){
                                            ...
                                            echo $row['nilai_akurasi']*100;echo ' %';
                                          }
                                        ?>
                                    </td>
                                    <td>
